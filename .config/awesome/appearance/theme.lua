...
local def_path = gfs.get_themes_dir() .. 'default/'
...
local gruvbox_colors = {
    ...
    light2      = '#d5c4a1',
    light1      = '#ebdbb2',
    light0      = '#fbf1c7', -- brighter

    -- high/mid/low are brightness level
    high_red    = '#fb4934',
    high_green  = '#b8bb26',
    high_yellow = '#fabd2f',
    high_blue   = '#83a598',
...
-- TODO: make a function that changes the colorscheme
-- and after than make an awesome applet
color = gruvbox_colors

-- this is a colorscheme not a palette
local light_scheme = {

    bg_normal = color.light0
    bg_focus  = color.light2
    bg_urgent = color.mid_red
    fg_normal = color.dark0
    fg_focus  = color.dark0
    fg_urgent = color.light1
    border_color_active = color.high_yellow
    border_color_normal = color.mid_yellow
    border_color_urgent = color.low_red
}
local theme = light_scheme

theme.useless_gap = dpi(8)
theme.border_width = dpi(1)
theme.border_width_floating = dpi(3)
theme.border_width_maximized = dpi(0)
theme.border_width_fullscreen = dpi(0)
theme.awesome_icon = nil

theme.wallpaper = "/home/mortar/bg/katanas.jpg"
...
-- Everything in the beautiful module
-- Default variables
-- theme.useless_gap = dpi(8)
-- theme.font = "sans 8"
-- theme.bg_normal = "#d5c4a1"
