...
vim.opt.tabstop = 2 -- how many spaces a tab char equals
vim.opt.shiftwidth = 2 -- inserted taps width (better to be same as tabstop)
vim.opt.softtabstop = 2 -- spaces when you press tab or backspace: default is 0
